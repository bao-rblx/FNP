export type ProductCategory = 'printing' | 'paper' | 'supplies' | 'services' | 'goods';
...
export const products: Product[] = [
  // Printing Services
  {
    ...
    price: 500,
    variants: [
      { id: 'bw', name: 'Đen Trắng', price: 500 },
      { id: 'color', name: 'In Màu', price: 2000 }
    ],
    category: 'printing',
  ...
  },
  {
    ...
    price: 3000,
    variants: [
      { id: 'bw', name: 'Đen Trắng', price: 3000 },
      { id: 'color', name: 'In Màu', price: 8000 }
    ],
    category: 'printing',
  ...
  },
  {
    ...
    price: 15000,
    variants: [
      { id: 'bw', name: 'Đen Trắng', price: 15000 },
      { id: 'color', name: 'In Màu', price: 30000 }
    ],
    category: 'printing',
    image: 'https://fact-depot.com/tmp/cache/images/_thumbs/720x720/media/product/14719/Giay-A3-Double-A-70-gsm.png',
    unit: 'mỗi bản',
  ...
  },
  {
    ...
    price: 30000,
    variants: [
      { id: 'bw', name: 'Đen Trắng', price: 30000 },
      { id: 'color', name: 'In Màu', price: 60000 }
    ],
    category: 'printing',
    image: 'https://fact-depot.com/tmp/cache/images/_thumbs/720x720/media/product/14719/Giay-A3-Double-A-70-gsm.png',
    unit: 'mỗi bản',
  ...
  },
  {
    ...
    price: 50000,
    variants: [
      { id: 'bw', name: 'Đen Trắng', price: 50000 },
      { id: 'color', name: 'In Màu', price: 100000 }
    ],
    category: 'printing',
    image: 'https://fact-depot.com/tmp/cache/images/_thumbs/720x720/media/product/14719/Giay-A3-Double-A-70-gsm.png',
    unit: 'mỗi bản',
